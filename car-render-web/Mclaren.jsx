...
export function McLaren(props) {
  ...
  useEffect(() => {
    rightDoorRef.current.rotation.x = Math.PI * value * rotationMagnitude.x;
    rightDoorRef.current.rotation.y = Math.PI * value * rotationMagnitude.y;
    rightDoorRef.current.rotation.z = Math.PI * value * rotationMagnitude.z;
    leftDoorRef.current.rotation.x = Math.PI * value * rotationMagnitude.x;
    leftDoorRef.current.rotation.y = Math.PI * value * rotationMagnitude.y;
    leftDoorRef.current.rotation.z = Math.PI * value * rotationMagnitude.z * -1;
  }, [value])
  ...
  return (
    <group {...rest} dispose={null}>
      ...
      <group position={[-0.817, 1.44, 0.617]} ref={rightDoorRef}>
      ...
      <group position={[0.861, 1.423, 0.559]} ref={leftDoorRef}>
